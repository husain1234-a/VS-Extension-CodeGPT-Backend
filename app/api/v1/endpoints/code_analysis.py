...
async def analyze_code(request: CodeAnalysisRequest):
    try:
        ...
        try:
            ...
            # Try to optimize and format the code
            ...
            # Enhance the context with code analysis results
            enhanced_context = {
            ...
            # Add detailed analysis of functions and classes
            ...
            # Send enhanced analysis to AI service with user prompt
            ...
            # Fall back to basic AI analysis if code analysis fails
            response = await ai_service.analyze_code(
                code=request.code,
